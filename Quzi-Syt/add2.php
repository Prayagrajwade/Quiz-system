...
if(isset($_POST['submitt'])){
 ...
 // First Query for Questions Table
	...
	$query = "INSERT INTO questions2 (";
	$query .= "question_number2, questions_text2 )";
	$query .= "VALUES (";
	...
	if($result){
		foreach($choice as $option => $value){
			if($value != ""){
				...
				$query = "INSERT INTO options2 (";
				$query .= "question_number2,is_correct2,coptions2)";
				$query .= " VALUES (";
		...
		$questions2= mysqli_query($connection,$query);
		$total = mysqli_num_rows($questions2);
		$next = $total+1;
